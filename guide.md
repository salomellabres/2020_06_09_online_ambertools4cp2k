...
## [Automated Version Control]({{ page.root }}{% link _episodes/01-overview.md %})
...
## [Creating a Repository]({{ page.root }}{% link _episodes/03-prepPDB.md %})
...
## [Tracking Changes]({{ page.root }}{% link _episodes/04-parameters.md %})
...
## [Ignoring Things]({{ page.root }}{% link _episodes/05-leap.md %})
## [Ignoring Things]({{ page.root }}{% link _episodes/06-minimisation.md %})

Just remember that you can use wildcards and regular expressions to ignore a
particular set of files in `.gitignore`.

## [Remotes in GitHub]({{ page.root }}{% link _episodes/07-therm.md %})
...
## [Collaborating]({{ page.root }}{% link _episodes/08-parmed.md %})
...
## [Conflicts]({{ page.root }}{% link _episodes/09-qmmm.md %})
